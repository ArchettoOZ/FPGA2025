...
Function_cholesky_sqrt_op_fixed:;
    ...
    ap_fixed<W, I, Q, O, N> tmp = fixed_sqrt_fast<W, I, 6, 4>(a);
    b = tmp;
    return (0);
}
...
#pragma HLS PIPELINE II = CholeskyTraits::INNER_II
                ...
                typename CholeskyTraits::ACCUM_T tmp_off_accum = sum[j];
                typename CholeskyTraits::ACCUM_T tmp_off_scaled;
                auto Ljj_real_div = hls::x_real(new_L_diag);
                cholesky_div_by_real(tmp_off_accum, Ljj_real_div, tmp_off_scaled);
...
#pragma HLS PIPELINE II = 1
    ...
    ap_fixed<48, 16, AP_RND_CONV, AP_SAT, 0> diag_sqrt_wide = fixed_sqrt_fast<48, 16, 6, 4>(diag_in);
